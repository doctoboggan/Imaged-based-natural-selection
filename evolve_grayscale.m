function [finalChild lastFitness] = evolve_grayscale(mommy,daddy,fertility,generations,percentMutated,mutationRate,goal)
...
for mm=1:generations
    for nn=1:fertility 
        ...
        %earlier. To create the mutations we create a random matrix the
        ...
        children(:,:,nn)=abs((sperm.*daddy+egg.*mommy)-(randsrc(1,1,[1 0;percentMutated 1-percentMutated]).*((randsrc(m,n,[1 0;mutationRate 1-mutationRate])).*floor((rand(m,n))*255))));
